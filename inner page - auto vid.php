...
?>
    ...
    <div class="thumbnails-container">
        ...
        <div class="video-thumbnail"><video src="" height=370 width=100% controls ></video>
        <button style="margin-left: 10px; margin-top: 20px; color: white; background-color: black; border-radius: 20px;
      padding: 8px 8px;">Subscribe</button>
        <button style=" margin-left: 345px; color: black; background-color: rgb(235, 229, 229); border-radius: 8px;
...
<textarea rows="7" cols="0" id="text">Write a comment
</textarea><br>
<button type="Submit" id="submit-btn">Submit</button>
        ...
        <div class="Suggestion-thumbnail" ><img src="<?php echo $row["thumbnail"]; ?>" header=250 width=250 alt="">
        </div>
